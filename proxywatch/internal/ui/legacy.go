...
// ── Key Mapping ─────────────────────────────────────────────────────────────
// convertKeyMsg translates a bubbletea KeyMsg into a tcell EventKey for use
// with the legacy key handlers.
...
// ── Virtual Screen ──────────────────────────────────────────────────────────
// VirtualScreen is an in-memory implementation of tcell.Screen that captures
// draw calls. After existing Draw* functions populate the cells, Render()
// converts the grid to an ANSI string for bubbletea's View().
...
// tcell.Screen interface — no-op stubs for unused methods.
...
// Render converts the virtual screen to an ANSI string for bubbletea's View().
