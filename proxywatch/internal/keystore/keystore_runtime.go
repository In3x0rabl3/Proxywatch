...
func IsSecretKey(key string) bool {
	...
	case "LOCAL_LLM_URL", "BLOODHOUND_API_URL", "OPENAI_BASE_URL", "ANTHROPIC_BASE_URL", "CALIBRATION_HTTP_TIMEOUT", "PROXYWATCH_TLS_DIR", "PROXYWATCH_DISABLE_CLIENT_CERT", "PROXYWATCH_TRUST_ON_FIRST_USE", "PROXYWATCH_DETECT_DEBUG_LOG", "PROXYWATCH_DETECT_RULES_JSON", "PROXYWATCH_SENTINEL_AUTH", "PROXYWATCH_SENTINEL_DCE_ENDPOINT", "PROXYWATCH_SENTINEL_DCR_ID", "PROXYWATCH_SENTINEL_STREAM_NAME", "AZURE_TENANT_ID", "AZURE_CLIENT_ID", "PROXYWATCH_SIEM_SOURCE_REPORT", "PROXYWATCH_SIEM_PROVIDER", "PROXYWATCH_SIEM_MODEL", "PROXYWATCH_SIEM_REPORT_OUTPUT", "PROXYWATCH_SIEM_JSON_OUTPUT":
		return false
	default:
		return true
	}
